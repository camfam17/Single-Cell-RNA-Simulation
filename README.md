...
The rest of the data, including trained/fit simulator models, simulated count matrices and other time consuming analyses are accesable here: https://drive.google.com/file/d/1szpmLp_7kbIf9w-rZAg75QrC24xcWZ27/view?usp=drive_link  
